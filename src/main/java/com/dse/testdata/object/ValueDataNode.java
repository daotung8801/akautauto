...
//                        && Search2.getExpectedValue(this) != null;
    ...
    public boolean isLambdaVariable() {
        return getParent() instanceof RootDataNode
                && ((RootDataNode) getParent()).getLevel() == NodeType.LAMBDA;
    }
    ...
    @Override
    public String getInputForGoogleTest(boolean isDeclared) throws Exception { // TODO: them case lambda cho cac lop khac
        if (isUseUserCode()) {
