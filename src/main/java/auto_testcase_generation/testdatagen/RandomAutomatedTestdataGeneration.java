...
public class RandomAutomatedTestdataGeneration extends AbstractAutomatedTestdataGeneration {
    ...
    protected TestCase generateTestdata(int iteration, ICommonFunctionNode fn, TestPrototype selectedPrototype,
        ...
        // generate random value for lambda
        List<RandomValue> randomValuesForLambdaVariables = generateRandomValuesForLambda(root, sut, testCase);
        if (randomValuesForLambdaVariables.size() != 0)
            newTestCaseInStr += randomValuesForLambdaVariables.toString();
        logger.debug("randomValuesForLambdaVariables = " + randomValuesForLambdaVariables);
